#This program was first written by Ethan Rarity (erarity@masonlive.gmu.edu) and Steve Schluchter (steven.schluchter@gmail.com)
#It is now being reworked by Steve Schluchter for another purpose.
#
#   Notes:
#
...
fileN = path.join(txts_dir, filenamelist[0])
with open(fileN + '-results.txt', 'w') as res_file:
    ...
    with open(filename, 'r') as in_file:
        for line in in_file:
            ...
            if(words[0] == "LEN"):
                ...
                res_file.write('Read list as: ')
                res_file.write(str(permlist))
                ...
                if(words[1] is None or words[2] is None):
                    ...
                    res_file.write('\nAdding edge ')
                    res_file.write(str(edgeind))
                    res_file.write(' as: (')
                    res_file.write(str(edgeTuple[0]))
                    res_file.write(',')
                    res_file.write(str(edgeTuple[1]))
                    res_file.write(')')
    ...
    if(topDuals >= 1):
        ...
        res_file.write('\nThere were ')
        res_file.write(str(topDuals))
        res_file.write(' topological duals found.\n')
    elif(topDuals == 0):
    ...
    if(winners >= 1):
        ...
        res_file.write('\nThere were ')
        res_file.write(str(winners))
        res_file.write(' winners found.\n')
    elif(winners == 0):
